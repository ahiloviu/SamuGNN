...
from model.GNNeco import GNNModel
...
if __name__ == '__main__':
    ...
    config = GlobalConfig('config/global_configeco.yaml', 'config/normalization_parameters.ini')
    ...
    path = config.get('data.training_path')
